  ...
  factory AuthFailure.fromCode(String code) {
    switch (code) {
      case 'bad_code_verifier':
        return const AuthFailure('The provided code verifier does not match the expected one.');
      case 'bad_json':
        return const AuthFailure('The request body is not valid JSON.');
      case 'bad_jwt':
        return const AuthFailure('The JWT provided is not valid.');
      case 'bad_oauth_callback':
        return const AuthFailure('OAuth callback from provider is missing required attributes.');
      ...
      case 'email_conflict_identity_not_deletable':
        return const AuthFailure('Cannot unlink this identity. Email address already in use.');
      case 'email_exists':
      ...
      case 'flow_state_expired':
        return const AuthFailure('Sign-in flow state has expired. Please sign in again.');
      case 'flow_state_not_found':
        return const AuthFailure('Sign-in flow state not found. Please sign in again.');
      case 'identity_already_exists':
        return const AuthFailure('Identity already linked to another user.');
      case 'identity_not_found':
        return const AuthFailure('Identity not found.');
      case 'insufficient_aal':
        return const AuthFailure('Higher Authenticator Assurance Level required.');
      ...
      case 'mfa_challenge_expired':
        return const AuthFailure('MFA challenge expired. Please request a new challenge.');
      case 'mfa_factor_name_conflict':
        return const AuthFailure('MFA factors should not have the same name.');
      case 'mfa_factor_not_found':
        return const AuthFailure('MFA factor not found.');
      case 'mfa_ip_address_mismatch':
        return const AuthFailure('MFA enrollment must use the same IP address.');
      case 'mfa_verification_failed':
        return const AuthFailure('MFA verification failed. Incorrect TOTP code.');
      ...
      case 'over_email_send_rate_limit':
        return const AuthFailure('Too many emails sent to this address. Please wait.');
      case 'over_request_rate_limit':
        return const AuthFailure('Too many requests. Please wait.');
      case 'over_sms_send_rate_limit':
        return const AuthFailure('Too many SMS messages sent to this number. Please wait.');
      case 'phone_exists':
      ...
      case 'provider_email_needs_verification':
        return const AuthFailure('Email verification required after OAuth sign-in.');
      ...
      case 'same_password':
        return const AuthFailure('New password must be different from the current one.');
      ...
      case 'saml_relay_state_expired':
        return const AuthFailure('SAML relay state expired. Please sign in again.');
      case 'saml_relay_state_not_found':
        return const AuthFailure('SAML relay state not found. Please sign in again.');
      ...
      case 'single_identity_not_deletable':
        return const AuthFailure('Cannot delete the only identity for this user.');
      case 'sms_send_failed':
        return const AuthFailure('Failed to send SMS. Check your provider configuration.');
      ...
      case 'unexpected_failure':
        return const AuthFailure('Unexpected failure. Auth service is degraded.');
      ...
      case 'user_sso_managed':
        return const AuthFailure('Cannot update fields for SSO managed user.');
      case 'validation_failed':
        return const AuthFailure('Validation failed. Check your input.');
      case 'weak_password':
        return const AuthFailure('Weak password. Please choose a stronger password.');
      default:
